      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="h-12 rounded-xl border-2 border-slate-200 bg-white pl-10 text-slate-800 placeholder:text-slate-300 transition-colors focus:border-indigo-400 focus:ring-indigo-100"
          />
        </div>
      </div>
